...
//   // for just the Hubble satellite - we don't need everything else on the screen 
//
//    // set position 
//   pDemo->ptHubble.setMetersX(0.0);
//   pDemo->ptHubble.setMetersY(42164000.0);
//
//   // time per frame 
//   double tpf = pDemo->time.timePerFrameEquation();
//
//   double v = -3100.0; // velocity 
//
//   // move the hubble
//   double xt = v * tpf; // change this later to horizontalDistanceEquation() 
//   pDemo->ptHubble.setMetersX(pDemo->ptHubble.getMetersX() + xt);
//
//   // rotate the earth
...
//   /*gout.drawHubble    (pDemo->ptHubble,     pDemo->angleShip);*/// draw the hubble! 
